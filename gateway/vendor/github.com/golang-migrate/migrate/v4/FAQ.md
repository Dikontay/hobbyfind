...
#### Can I use migrate with a non-Go github.com/Dikontay/hobbyfind/gateway?
Yes, you can use the migrate CLI in a non-Go github.com/Dikontay/hobbyfind/gateway, but there are probably other libraries/frameworks available that offer better test and deploy integrations in that language/framework.
