...
Swag converts Go annotations to Swagger Documentation 2.0. We've created a variety of plugins for popular [Go web frameworks](#supported-web-frameworks). This allows you to quickly integrate with an existing Go github.com/Dikontay/hobbyfind/gateway (using Swagger UI).
...
- [About the Project](#about-the-github.com/Dikontay/hobbyfind/gateway)
...
3. Run `swag init` in the github.com/Dikontay/hobbyfind/gateway's root folder which contains the `main.go` file. This will parse your comments and generate the required files (`docs` folder and `docs/docs.go`).
```sh
swag init
```
...
If the struct is defined in your main github.com/Dikontay/hobbyfind/gateway, use `--parseInternal`.
...
## About the Project
This github.com/Dikontay/hobbyfind/gateway was inspired by [yvasiyarov/swagger](https://github.com/yvasiyarov/swagger) but we simplified the usage and added support a variety of [web frameworks](#supported-web-frameworks). Gopher image source is [tenntenn/gopher-stickers](https://github.com/tenntenn/gopher-stickers). It has licenses [creative commons licensing](http://creativecommons.org/licenses/by/3.0/deed.en).
## Contributors

This github.com/Dikontay/hobbyfind/gateway exists thanks to all the people who contribute. [[Contribute](CONTRIBUTING.md)].
...
Support this github.com/Dikontay/hobbyfind/gateway by becoming a sponsor. Your logo will show up here with a link to your website. [[Become a sponsor](https://opencollective.com/swag#sponsor)]
