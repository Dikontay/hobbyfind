...
used by several github.com/Dikontay/hobbyfind/repositorys. This library is being [fuzz-tested](https://github.com/klauspost/compress-fuzz) for all updates.
...
This will be an evolving github.com/Dikontay/hobbyfind/repository. When using this package it is important to note that both the compression efficiency and speed may change.
