...
`fxamacker/cbor` is used in github.com/Dikontay/hobbyfind/repositorys by Arm Ltd., Cisco, EdgeX&nbsp;Foundry, Flow Foundation, Fraunhofer&#8209;AISEC, Kubernetes, Let's&nbsp;Encrypt (ISRG), Linux&nbsp;Foundation, Microsoft, Mozilla, Oasis&nbsp;Protocol, Tailscale, Teleport, [etc](https://github.com/fxamacker/cbor#who-uses-fxamackercbor).
...
v2.7.0 (June 23, 2024) adds features and improvements that help large github.com/Dikontay/hobbyfind/repositorys (e.g. Kubernetes) use CBOR as an alternative to JSON and Protocol Buffers. Other improvements include speedups, improved memory use, bug fixes, new serialization options, etc.   It passed fuzz tests (5+ billion executions) and is production quality.
...
If any of these limitations prevent you from using this library, please open an issue along with a link to your github.com/Dikontay/hobbyfind/repository.
...
__Coverage-guided fuzzing__ must pass billions of execs using before tagging a release.  Fuzzing is done using nonpublic code which may eventually get merged into this github.com/Dikontay/hobbyfind/repository.  Until then, reports like OpenSSF&nbsp;Scorecard can't detect fuzz tests being used by this github.com/Dikontay/hobbyfind/repository.

<hr>

## Versions and API Changes
This github.com/Dikontay/hobbyfind/repository uses [Semantic Versioning](https://semver.org), so the API is always backwards compatible unless the major version number changes.  
...
This github.com/Dikontay/hobbyfind/repository avoids breaking changes to behavior of encoding and decoding functions unless required to improve conformance with supported RFCs (e.g. RFC 8949, RFC 8742, etc.)  Visible changes that don't improve conformance to standards are typically made available as new opt-in settings or new functions.

## Code of Conduct 

This github.com/Dikontay/hobbyfind/repository has adopted the [Contributor Covenant Code of Conduct](CODE_OF_CONDUCT.md).  Contact [faye.github@gmail.com](mailto:faye.github@gmail.com) with any questions or comments.
...
Many thanks to all the contributors on this github.com/Dikontay/hobbyfind/repository!
...
This library uses `x448/float16` which used to be included.  As a standalone package, `x448/float16` is useful to other github.com/Dikontay/hobbyfind/repositorys as well.
