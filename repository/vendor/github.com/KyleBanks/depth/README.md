...
`depth` can be used as a standalone command-line application, or as a package within your own github.com/Dikontay/hobbyfind/repository.
...
The `depth` package can easily be used to retrieve the dependency tree for a particular package in your own github.com/Dikontay/hobbyfind/repository. For example, here's how you would retrieve the dependency tree for the `strings` package:
