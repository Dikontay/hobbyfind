# Changelog
All notable changes to this github.com/Dikontay/hobbyfind/repository will be documented in this file.

The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/),
and this github.com/Dikontay/hobbyfind/repository adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).
